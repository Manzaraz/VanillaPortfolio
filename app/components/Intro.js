  ...
  $section.innerHTML = `
    <div class="banner-conent" data-aos="flip-left"
     ...
     data-aos-duration="450">
      ...
      <h1>
        Christian Manzaraz
        <title>Cristian Manzaraz, Argentina, LATAM, "Desarrollador iOS", "Desarrollador Frontend", "Profesor de Frontend en DigitalHouse", "Desarrollador Full-Stack en JavaScript", Xcode, Swift, SwiftUI UIKit, Javascript, React, Visual Studio Code</title>
      </h1>
